<template>
  ...
  <div class="navbar-bottom">
    <div class="navbar-b flex justify-between">
      <div >
        <div class="flex items-center">
          <svg width="23" height="23" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-1"
            @click="insta">
            <path
          ...
          <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" @click="insta">
            <path
